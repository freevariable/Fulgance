...
- mp.py, the train engine simulator itself. Sims are complex beasts, you should check out our *tutorials below*
...
- tr.py, the traffic manager (the brain, providing path information to the simulator). Under development.
...
- you may NOT run the traffic manager as of now (this is slated for ALPHA THREE)
...
To be completed. The traffic manager is not avalaible for now.
